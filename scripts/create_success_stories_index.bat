@echo off
REM Create Firestore composite index for success stories
REM This script creates the required index for the success_stories collection

echo 🔥 Creating Firestore composite index for success_stories collection...

REM Using Firebase CLI to create the index
